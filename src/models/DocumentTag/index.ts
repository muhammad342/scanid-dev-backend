...
interface DocumentTagCreationAttributes 
  extends Optional<DocumentTagAttributes, 'id' | 'description' | 'color' | 'useMasterPin' | 'useDocumentViewPin' | 'reminderEnabled' | 'reminderDays' | 'expirationDate' | 'createdAt' | 'updatedAt'> {}

export class DocumentTag extends Model<DocumentTagAttributes, DocumentTagCreationAttributes> 
  implements DocumentTagAttributes {
  public id!: string;
